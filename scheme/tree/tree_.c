...
; File: "tree_.c", produced by Gambit-C v4.2.6
(
402006
" tree_"
(" _kernel" " _system" " _num" " _std" " _eval" " _io" " _nonstd" " _thread" " _repl" " tree")
(
""
"##and"
"##apply"
...
#define ___LINKFILE_NAME " tree_"
#define ___LINKER_ID ____20_tree__
...
___BEGIN_NEW_LNK
___DEF_NEW_LNK(____20_tree)
___END_NEW_LNK

___BEGIN_LNK
 ___DEF_LNK(____20___gambc)
,___DEF_LNK(____20_tree)
___END_LNK
...
___DEF_SUB_NSTR(___X0,5)
               ___NSTR5(32,116,114,101,101)
___DEF_NEW_SYM_GLO_SUP(0,___S__20_tree,___X0,15508699,___G__20_tree)
___DEF_SUB_NSTR(___X1,8)
               ___NSTR8(103,101,116,45,100,97,116,97)
               ___NSTR0
___DEF_NEW_SYM_GLO_SUP(___S__20_tree,___S_get_2d_data,___X1,91752802,___G_get_2d_data)
___DEF_SUB_NSTR(___X2,8)
               ___NSTR8(103,101,116,45,108,101,102,116)
               ___NSTR0
___DEF_NEW_SYM_GLO_SUP(___S_get_2d_data,___S_get_2d_left,___X2,135258665,___G_get_2d_left)
___DEF_SUB_NSTR(___X3,9)
               ___NSTR8(103,101,116,45,114,105,103,104)
               ___NSTR1(116)
___DEF_NEW_SYM_GLO_SUP(___S_get_2d_left,___S_get_2d_right,___X3,460754658,___G_get_2d_right)
___DEF_SUB_NSTR(___X4,8)
               ___NSTR8(105,110,45,111,114,100,101,114)
               ___NSTR0
___DEF_NEW_SYM_GLO_SUP(___S_get_2d_right,___S_in_2d_order,___X4,46312739,___G_in_2d_order)
___DEF_SUB_NSTR(___X5,6)
               ___NSTR6(105,110,115,101,114,116)
___DEF_NEW_SYM_GLO_SUP(___S_in_2d_order,___S_insert,___X5,154723776,___G_insert)
___DEF_SUB_NSTR(___X6,5)
               ___NSTR5(105,115,45,105,110)
___DEF_NEW_SYM_GLO_SUP(___S_insert,___S_is_2d_in,___X6,51374941,___G_is_2d_in)
___DEF_SUB_NSTR(___X7,7)
               ___NSTR7(105,115,45,108,101,97,102)
___DEF_NEW_SYM_GLO_SUP(___S_is_2d_in,___S_is_2d_leaf,___X7,499982081,___G_is_2d_leaf)
___DEF_SUB_NSTR(___X8,9)
               ___NSTR8(108,115,116,45,62,116,114,101)
               ___NSTR1(101)
___DEF_NEW_SYM_GLO_SUP(___S_is_2d_leaf,___S_lst_2d__3e_tree,___X8,257345362,___G_lst_2d__3e_tree)
___DEF_SUB_NSTR(___X9,9)
               ___NSTR8(109,97,107,101,45,116,114,101)
               ___NSTR1(101)
___DEF_NEW_SYM_GLO_SUP(___S_lst_2d__3e_tree,___S_make_2d_tree,___X9,171704616,___G_make_2d_tree)
___DEF_SUB_NSTR(___X10,10)
               ___NSTR8(110,117,109,45,108,101,97,118)
               ___NSTR2(101,115)
___DEF_NEW_SYM_GLO_SUP(___S_make_2d_tree,___S_num_2d_leaves,___X10,99053654,___G_num_2d_leaves)
___DEF_SUB_NSTR(___X11,5)
               ___NSTR5(116,114,101,101,49)
___DEF_NEW_SYM_GLO_SUP(___S_num_2d_leaves,___S_tree1,___X11,412697534,___G_tree1)
___END_NEW_SYM_GLO(___S_tree1,0)
